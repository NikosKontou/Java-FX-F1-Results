...
public class InsertRaceDataController {
    ...
    if ((checkForNulls(trackName, year, round, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20) )&&(dba.insertRace(trackName.getText(), Integer.parseInt(year.getText()), Integer.parseInt(round.getText()), Integer.parseInt(p1.getText().toString())
    ...
    public void insertQualifyingData(ActionEvent event) throws SQLException, ClassNotFoundException {
        DBActions dba = new DBActions();
        //if there are no null textFields and the insertRace function is successful, show the according message
        if ((checkForNulls(trackName, year, round, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20) )&&(dba.insertQualifying(trackName.getText().toString(), Integer.parseInt(year.getText().toString()), Integer.parseInt(round.getText().toString()), Integer.parseInt(p1.getText().toString())
    ...
    private static Boolean checkForNulls (TextField year,TextField trackName,TextField round,TextField p1,TextField p2,TextField p3,TextField p4,TextField p5,TextField p6,TextField p7,TextField p8,TextField p9,TextField p10,TextField p11,TextField p12,TextField p13,TextField p14,TextField p15,TextField p16,TextField p17,TextField p18,TextField p19,TextField p20) {
        if (Stream.of(year, trackName, round, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20).anyMatch(textField -> textField.getText().isEmpty()) || Stream.of( p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20).anyMatch(textField -> !CheckInputs.checkDriverNumber(textField.getText()))) {
            return false;
        }
        else {
            return true;
